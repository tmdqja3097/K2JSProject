...
public class MatchController {
	...
	public void match() {
		...
		//totalDate = 전체 날짜 수
		//remainDate = 남은 날짜 수
		int firstDate = cal.getActualMinimum(cal.DATE);
		int totalDate = cal.getActualMaximum(cal.DATE);
		int remainDate = cal.getActualMaximum(cal.DATE)-day;
		
		System.out.println(remainDate);

		int [] dat = new int[remainDate+1];
