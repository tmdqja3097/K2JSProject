			...
			<form method="POST">
				<fieldset>
					<div class="row">
						<label>아이디</label><br> <input type="text" name="id"
							maxlength="15" autofocus required id="id" autofocus>
					</div>
					...
					<div class="row">
						<label>비밀번호 확인</label><br> <input type="password" name="pw1"
						id="pw1"
							required id="password2"> <span hidden="visible" id="msg" >비밀번호가
							일치/일치하지 않습니다.</span>
					</div>
					<div class="row">
						<label>이메일</label><br> <input type="text" name="eamil"
							maxlength="150" autofocus required id="eamil" autofocus>
					</div>
					<div class="row">
						<label>이름</label><br> <input type="text" name="name" required
							id="name">
					</div>
					<br>
					<div class="row">
				...
				<div class="row">
					<span title="agree">K2JS <a href="#" target="_blank">서비스
						...
						동의합니다.
					</span> <input type="checkbox" name="checkbox" id="agree" required>
				</div>
				<br>
				<div class="row">
