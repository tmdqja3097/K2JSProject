...
<body>
	<p>
		<span><환급률 안내></span> *2일 전 : 100% 환급/1일 전 : 80% 환급 /당일 1시간 30분
		전까지: 20% 환급
	</p>
	<p>/당일 1시간 30분 미만: 0% 환급 *취소 환급액은 취소일에 따라 비율이 상이하며 취소 없이 무단 불참 시
		서비스 이용에</p>
	<p>제한이 있을 수 있습니다. *경기 변경 또한 같은 환급률이 적용되오니 신중히 신청 부탁드립니다.</p>
	<br>
	<br>
