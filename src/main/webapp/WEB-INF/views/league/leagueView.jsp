	...
	<div class="card" style="width: 100%; height: 150px;">
		<div class="card_car" style="width: 100%; height: 65px;">
			<ul class="card_man" style="width: 35%; height: 65px;">
				<a href="./leagueGender?gender=1" style="text-decoration: none; color:black;">
					<li class="card_sub" id="cs1" style="float: left;">
						<img alt=""
							src="${pageContext.request.contextPath}/resources/images/manGraph.svg"
							style="width: 100%; height: 25px; "> 남자 랭킹
					</li>
				</a>   
				<a href="./leagueGender?gender=2" style="text-decoration: none; color:black;">
					<li class="card_sub" id="cs2" style="float: right;">
						<img alt=""
							src="${pageContext.request.contextPath}/resources/images/womanGraph.svg"
							style="width: 100%; height: 25px;"> 여자 랭킹
					</li>
				</a>
			</ul>
		</div>
	...
	<div class="ranks_card">
		...
		<h2> 랭킹 </h2>
			...
			<table class="table">
				...
				<a href="./leagueTotal" style="float: right; text-decoration: none; color:#333;">전체 순위 보기</a>
